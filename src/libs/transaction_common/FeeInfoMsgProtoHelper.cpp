...
FeeInfoMsgProtoHelper::FeeInfoMsgProtoHelper(const long fee) {
    this->feeInfoMsg.set_version(keto::common::MetaInfo::PROTOCOL_VERSION);
...
FeeInfoMsgProtoHelper& FeeInfoMsgProtoHelper::setFeeRatio(const long fee) {
    this->feeInfoMsg.set_fee_ratio(fee);
    return *this;
}

long FeeInfoMsgProtoHelper::getFeeRatio() {
