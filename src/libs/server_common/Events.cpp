...
const char* Events::CONSENSUS::MEMORY_VAULT_MANAGER_QUERY    = "CONSENSUS_MEMORY_VAULT_MANAGER";
...
const char* Events::CONSENSUS_SESSION_ACCEPTED::MEMORY_VAULT_MANAGER_QUERY    = "CONSENSUS_SESSION_ACCEPTED_MEMORY_VAULT_MANAGER";
