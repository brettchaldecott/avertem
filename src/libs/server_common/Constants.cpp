...
const char* Constants::RPC_COMMANDS::MISSING_BLOCK_SYNC_REQUEST = "MISSING_BLOCK_SYNC_REQUEST";
const char* Constants::RPC_COMMANDS::MISSING_BLOCK_SYNC_RESPONSE = "MISSING_BLOCK_SYNC_RESPONSE";
...
const char* Constants::RPC_COMMANDS::CLOSE_EXIT = "CLOSE_EXIT";
...
const char* Constants::RPC_COMMANDS::REQUEST_NETWORK_STATUS = "REQUEST_NETWORK_STATUS";
const char* Constants::RPC_COMMANDS::RESPONSE_NETWORK_STATUS = "RESPONSE_NETWORK_STATUS";
