...
const long Constants::SYNC_RETRY_DELAY_MIN  = 100;



const long Constants::SYNC_EXPIRY_TIME  = 30 + (60 * 2);


// tangle configuration
const int Constants::MAX_TANGLE_ACCOUNTS = 20000;
const int Constants::MAX_TANGLES_TO_ACCOUNT = 3;
