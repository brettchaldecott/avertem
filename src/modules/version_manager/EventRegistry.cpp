...
void EventRegistry::registerEventHandlers() {
    ...
    keto::server_common::registerEventHandler (
            ...
            &keto::version_manager::EventRegistry::consensusSessionAccepted);
    keto::server_common::registerEventHandler (
            keto::server_common::Events::CONSENSUS_SESSION_CHECK::VERSION,
            &keto::version_manager::EventRegistry::consensusProtocolCheck);
    keto::server_common::registerEventHandler (
            keto::server_common::Events::CONSENSUS_HEARTBEAT::VERSION,
            &keto::version_manager::EventRegistry::consensusHeartbeat);
}
