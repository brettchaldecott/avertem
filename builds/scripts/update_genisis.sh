...
${WORK_DIR}/build/install/bin/keto_contract_tools.sh -e -s ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/contract_optimized.wasm -t ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/contract_optimized.hex
CONTRACT_HEX_ID=$(cat ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/contract_optimized.hex)
${WORK_DIR}/build/install/bin/keto_contract_tools.sh -e -s ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/namespace_optimized.wasm -t ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/namespace_optimized.hex
NAMESPACE_HEX_ID=$(cat ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/namespace_optimized.hex)
${WORK_DIR}/build/install/bin/keto_contract_tools.sh -e -s ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/sidechain_optimized.wasm -t ${WORK_DIR}/src/contracts/keto_standard_typscript_contracts/build/sidechain_optimized.hex
